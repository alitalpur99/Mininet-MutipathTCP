...
def topology():
	...
	net.addLink(h1, s1, intfName1='h1-eth0', intfName2='s1-eth1',bw=100)
	net.addLink(h2, s2, intfName1='h2-eth0', intfName2='s2-eth1',bw=100)
	net.addLink(h3, s3, intfName1='h3-eth0', intfName2='s3-eth1',bw=100)
	net.addLink(h4, s4, intfName1='h4-eth0', intfName2='s4-eth1',bw=100)

	net.addLink(s1, s2, intfName1='s1-eth2', intfName2='s2-eth2',bw=100)#, delay='20ms')
	net.addLink(s2, s3, intfName1='s2-eth3', intfName2='s3-eth2',bw=100)#, delay='20ms')
	net.addLink(s3, s4, intfName1='s3-eth3', intfName2='s4-eth2',bw=100, delay='5ms')#, delay='20ms')
