...
# c2=[]
# dic2=dict()
# with open("switch2-time.txt") as f2:
# 	for l2 in f2:
# 		l2=l2.strip()
# 		l2=l2.split("\t")
# 		t2.append(l2[0])
...
# # dic=dict()
# # open("s1s2keyok","w").close()
# # with open("s1s2keyok","w+") as fkey:
...
# # 	print sorted_dic1[i]
# # print len(sorted_dic1)
# # for i in range(len(sorted_dic2)):
# # 	print sorted_dic2[i]
# # print len(sorted_dic2)
# ###########################################
...
# open("sortedtupless1s2","w").close()

# with open("sortedtupless1s2","w+") as sf:
...
t_s1=[]
diff=[]
with open("sortedtupless1s2") as f:
...
with open("owd","w+") as f:
	for i in range(len(diff)):
		...
		if str(diff[i]).startswith("-1"):
			f.write(str(t2_time)+" "+str('00.000000'))
			f.write("\n")
		else:
